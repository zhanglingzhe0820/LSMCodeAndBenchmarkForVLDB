...
java -jar -Djava.ext.dirs=../iotdb-with_seperation_policy_no_deletion/apache-iotdb-0.12.1-SNAPSHOT-all-bin/lib pure_write.jar ${csv_path} > tlsm_$1_$2_$3_write.log
